...
import nc.util.*;
import nclegacy.tile.TileFluidProcessorLegacy;
...
public abstract class GuiFluidProcessorLegacy extends NCGuiLegacy {
	
	protected final EntityPlayer player;
	protected final TileFluidProcessorLegacy tile;
	protected final ResourceLocation gui_textures;
	protected GuiItemRenderer speedUpgradeRender = null, energyUpgradeRender = null;
	
	public GuiFluidProcessorLegacy(String name, EntityPlayer player, TileFluidProcessorLegacy tile, Container inventory) {
		super(inventory);
		this.player = player;
		this.tile = tile;
	...
	public List<String> energyInfo(ITileEnergy tileEnergy) {
		...
		return Lists.newArrayList(TextFormatting.LIGHT_PURPLE + Lang.localize("gui.nc.container.energy_stored") + TextFormatting.WHITE + " " + energy, TextFormatting.LIGHT_PURPLE + Lang.localize("gui.nc.container.process_power") + TextFormatting.WHITE + " " + power, TextFormatting.AQUA + Lang.localize("gui.nc.container.speed_multiplier") + TextFormatting.WHITE + " " + speedMultiplier, TextFormatting.AQUA + Lang.localize("gui.nc.container.power_multiplier") + TextFormatting.WHITE + " " + powerMultiplier);
	}
