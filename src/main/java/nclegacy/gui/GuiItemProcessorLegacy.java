...
import nc.util.*;
import nclegacy.tile.TileItemProcessorLegacy;
...
public abstract class GuiItemProcessorLegacy extends NCGuiLegacy {
	
	protected final EntityPlayer player;
	protected final TileItemProcessorLegacy tile;
	protected final ResourceLocation gui_textures;
	protected GuiItemRenderer speedUpgradeRender = null, energyUpgradeRender = null;
	
	public GuiItemProcessorLegacy(String name, EntityPlayer player, TileItemProcessorLegacy tile, Container inventory) {
		super(inventory);
		this.player = player;
		this.tile = tile;
