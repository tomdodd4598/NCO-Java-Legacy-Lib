...
import nc.util.*;
import nclegacy.container.ContainerSorptionsLegacy;
...
public abstract class GuiItemSorptionsLegacy<T extends ITileInventory & ITileGuiLegacy<?>> extends NCGuiLegacy {
	
	protected final NCGuiLegacy parent;
	...
	public GuiItemSorptionsLegacy(NCGuiLegacy parent, T tile, int slot, ItemSorption.Type sorptionType) {
		super(new ContainerSorptionsLegacy<>(tile));
		this.parent = parent;
		this.tile = tile;
	...
	public static class Input<T extends ITileInventory & ITileGuiLegacy<?>> extends GuiItemSorptionsLegacy<T> {
		
		public Input(NCGuiLegacy parent, T tile, int slot) {
	...
	public static class Output<T extends ITileInventory & ITileGuiLegacy<?>> extends GuiItemSorptionsLegacy<T> {
		
		public Output(NCGuiLegacy parent, T tile, int slot) {
	...
	public static class SpeedUpgrade<T extends ITileInventory & ITileGuiLegacy<?>> extends Input<T> {
		
		public SpeedUpgrade(NCGuiLegacy parent, T tile, int slot) {
	...
	public static class EnergyUpgrade<T extends ITileInventory & ITileGuiLegacy<?>> extends Input<T> {
		
		public EnergyUpgrade(NCGuiLegacy parent, T tile, int slot) {
			super(parent, tile, slot);
