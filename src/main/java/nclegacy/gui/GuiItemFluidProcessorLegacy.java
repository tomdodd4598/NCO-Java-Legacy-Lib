...
public abstract class GuiItemFluidProcessorLegacy extends NCGuiLegacy {
	...
	public GuiItemFluidProcessorLegacy(String name, EntityPlayer player, TileItemFluidProcessorLegacy tile, Container inventory) {
		super(inventory);
		this.player = player;
		this.tile = tile;
