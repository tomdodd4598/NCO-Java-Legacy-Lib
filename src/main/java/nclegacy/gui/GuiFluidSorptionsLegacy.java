...
public abstract class GuiFluidSorptionsLegacy<T extends ITileFluid & ITileGuiLegacy<?>> extends NCGuiLegacy {
	...
	public GuiFluidSorptionsLegacy(NCGuiLegacy parent, T tile, int slot, TankSorption.Type sorptionType) {
	...
	public static class Input<T extends ITileFluid & ITileGuiLegacy<?>> extends GuiFluidSorptionsLegacy<T> {
	...
	public static class Output<T extends ITileFluid & ITileGuiLegacy<?>> extends GuiFluidSorptionsLegacy<T> {
