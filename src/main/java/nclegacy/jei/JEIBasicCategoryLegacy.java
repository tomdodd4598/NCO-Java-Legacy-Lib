...
public abstract class JEIBasicCategoryLegacy<WRAPPER extends JEIBasicRecipeWrapperLegacy<WRAPPER>> extends BlankRecipeCategory<WRAPPER> implements IRecipeHandler<WRAPPER> {
	
	protected final IJEIHandlerLegacy<WRAPPER> jeiHandler;
	
	public JEIBasicCategoryLegacy(IJEIHandlerLegacy<WRAPPER> jeiHandler) {
