...
public abstract class JEIMachineRecipeWrapperLegacy<WRAPPER extends JEIMachineRecipeWrapperLegacy<WRAPPER>> extends JEIBasicRecipeWrapperLegacy<WRAPPER> {
	
	private final int infoX, infoY, infoWidth, infoHeight;
	
	public JEIMachineRecipeWrapperLegacy(IGuiHelper guiHelper, IJEIHandlerLegacy<WRAPPER> handler, BasicRecipeHandler recipeHandler, BasicRecipe recipe, int backX, int backY, int arrowX, int arrowY, int arrowWidth, int arrowHeight, int arrowPosX, int arrowPosY, int infoX, int infoY, int infoWidth, int infoHeight) {
