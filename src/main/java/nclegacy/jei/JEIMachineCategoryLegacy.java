...
public abstract class JEIMachineCategoryLegacy<WRAPPER extends JEIBasicRecipeWrapperLegacy<WRAPPER>> extends JEIBasicCategoryLegacy<WRAPPER> {
	
	protected final IDrawable background;
	protected final String title;
	protected final int backPosX, backPosY;
	
	public JEIMachineCategoryLegacy(IGuiHelper guiHelper, IJEIHandlerLegacy<WRAPPER> handler, String blockName, int backX, int backY, int backWidth, int backHeight) {
		super(handler);
