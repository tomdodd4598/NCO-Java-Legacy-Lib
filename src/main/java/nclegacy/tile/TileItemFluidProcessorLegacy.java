...
public class TileItemFluidProcessorLegacy extends TileEnergyFluidSidedInventory implements IItemFluidProcessorLegacy, ITileSideConfigGuiLegacy<EnergyProcessorUpdatePacket>, IUpgradableLegacy {
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		...
		return NCConfig.smart_processor_input ? recipeHandler.isValidItemInput(stack, slot, getItemInputs(), getFluidInputs(), recipeInfo) : recipeHandler.isValidItemInput(stack, slot);
	}
