...
public abstract class TileItemGeneratorLegacy extends TileEnergySidedInventory implements IItemGeneratorLegacy {
	...
	public TileItemGeneratorLegacy(String name, int itemInSize, int itemOutSize, int otherSize, @Nonnull List<ItemSorption> itemSorptions, int capacity, @Nonnull BasicRecipeHandler recipeHandler) {
	...
	public boolean isItemValidForSlot(int slot, ItemStack stack) {
		...
		return smart_processor_input ? recipeHandler.isValidItemInput(stack, slot, getItemInputs(false), new ArrayList<>(), recipeInfo) : recipeHandler.isValidItemInput(stack, slot);
	}
	...
	public void clearAllSlots() {
		IItemGeneratorLegacy.super.clearAllSlots();
