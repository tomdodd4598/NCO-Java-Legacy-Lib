...
public abstract class TileFluidGeneratorLegacy extends TileEnergyFluidSidedInventory implements IFluidGeneratorLegacy {
	...
	public TileFluidGeneratorLegacy(String name, int fluidInSize, int fluidOutSize, int otherSize, @Nonnull List<ItemSorption> itemSorptions, @Nonnull IntList fluidCapacity, @Nonnull List<TankSorption> tankSorptions, List<Set<String>> allowedFluids, int capacity, @Nonnull BasicRecipeHandler recipeHandler) {
