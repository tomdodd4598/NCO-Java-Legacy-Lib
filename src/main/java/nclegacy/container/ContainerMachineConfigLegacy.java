...
public class ContainerMachineConfigLegacy<T extends ITileSideConfigGuiLegacy<?>> extends ContainerTileLegacy<T> {
	
	public ContainerMachineConfigLegacy(EntityPlayer player, T tile) {
		super(tile);
