...
public abstract class ContainerItemProcessorLegacy<PROCESSOR extends IItemProcessorLegacy & ITileGuiLegacy<?>> extends ContainerTileLegacy<PROCESSOR> {
	...
	public ContainerItemProcessorLegacy(EntityPlayer player, PROCESSOR tileEntity, BasicRecipeHandler recipeHandler) {
		super(tileEntity);
		tile = tileEntity;
