...
public class ContainerFluidProcessorLegacy<PROCESSOR extends IFluidProcessorLegacy & ITileGuiLegacy<?>> extends ContainerTileLegacy<PROCESSOR> {
	...
	public ContainerFluidProcessorLegacy(EntityPlayer player, PROCESSOR tileEntity, BasicRecipeHandler recipeHandler) {
		super(tileEntity);
		tile = tileEntity;
